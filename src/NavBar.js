      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex flex-col text-center">
          ...
          <div>
            <div className="flex justify-center items-baseline space-x-4">
              ...
              <a href="#" className="hover:bg-gray-700 text-white px-3 py-2 rounded-md text-sm font-medium">Schedule</a>
              <a href="#" className="hover:bg-gray-700 text-white px-3 py-2 rounded-md text-sm font-medium">Speakers</a>
              <a href="#" className="hover:bg-gray-700 text-white px-3 py-2 rounded-md text-sm font-medium">Register</a>
            </div>
          </div>
        </div>
        ...
        <div className={isOpen ? "lg:hidden" : "hidden"} id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#" className="hover:bg-gray-700 text-white block px-3 py-2 rounded-md text-base font-medium">Schedule</a>
            <a href="#" className="hover:bg-gray-700 text-white block px-3 py-2 rounded-md text-base font-medium">Speakers</a>
            <a href="#" className="hover:bg-gray-700 text-white block px-3 py-2 rounded-md text-base font-medium">Register</a>
          </div>
        </div>
      </div>
    </nav>
