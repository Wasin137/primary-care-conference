            ...
            <div className='grid grid-cols-1 md:grid-cols-[auto,1fr]'>
                <div>
                    <div className='p-4 bg-white rounded-lg shadow-md mb-4'>
                        ...
                        <Link href={'https://docs.google.com/forms/d/e/1FAIpQLSfRvES9UdtbMsZJig0bQQrZ2GmPvXYqf8J-IEB_uYBJFOKseQ/viewform?pli=1'}><span className='text-gray-500 text-xl font-bold hover:underline'>Click Here</span></Link>
                    </div>
