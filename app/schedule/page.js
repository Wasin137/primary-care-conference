...
const day1Room1 = {
    ...
    schedule:[ 
        ...
        {
            time:'15.00-16.30',
            topic:'การขับเคลื่อนระบบการจัดการโรคเรื้อรังระดับอําเภอ: จากแนวคิดสู่การเปลี่ยนแปลงบริการส่งเสริมป้องกันโรคเรื้อรังในระดับปฐมภูมิ NCD prevention service in primary care',
